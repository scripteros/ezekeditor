...
- **Monaco Editor:** O mesmo núcleo de edição de código do VS Code, garantindo alta performance e syntax highlighting.
- **Explorador de Arquivos:** Navegue e gerencie seus arquivos de projeto facilmente.
- **Integração com Git:** Veja status de arquivos e realize operações básicas de versionamento.
...
4. **Git:** O editor detecta automaticamente se a pasta aberta é um repositório Git e mostra o status dos arquivos na barra lateral.
