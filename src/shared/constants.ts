export const IPC_CHANNELS = {
  ...
  AUTH_INIT_LOCAL: 'auth:initLocal',
  AUTH_LOGIN_LOCAL: 'auth:loginLocal',
  AUTH_REGISTER_LOCAL: 'auth:registerLocal',
  ...
  // Local User Config Sync (JSON file)
  LOCAL_CONFIG_INIT: 'localConfig:init',
  LOCAL_CONFIG_SAVE_AI: 'localConfig:saveAI',
  LOCAL_CONFIG_LOAD_AI: 'localConfig:loadAI',
  LOCAL_CONFIG_SAVE_SQL: 'localConfig:saveSQL',
  LOCAL_CONFIG_LOAD_SQL: 'localConfig:loadSQL',
